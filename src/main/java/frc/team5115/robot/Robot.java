...
public class Robot extends TimedRobot {
    ...
    public static SendableChooser CANStateL;
    public static SendableChooser CANStateR;
    ...
    public void testInit(){
        //put our values onto the dashboard
        SmartDashboard.putNumber("Battery Voltage", RobotController.getBatteryVoltage());
        //PWM
        SmartDashboard.putNumber("Spark Left Current", leftVal);
        SmartDashboard.putNumber("Spark Right Current", rightVal);
        //CAN
        SmartDashboard.putNumber("CANBus utilization", );
        SmartDashboard.putString("Left Solenoid Current", intake.SolenoidValL());
        SmartDashboard.putString("Right Solenoid Current", intake.SolenoidValR());
        CANStateL = new SendableChooser();
        CANStateR = new SendableChooser();

        CANStateL.addDefault("Off", DoubleSolenoid.Value.kOff );
        CANStateL.addObject("Forward", DoubleSolenoid.Value.kForward);
        CANStateL.addObject("Reverse",  DoubleSolenoid.Value.kReverse);
        SmartDashboard.putData("Left Solenoid Control", CANStateL);

        CANStateR.addDefault("Off",  DoubleSolenoid.Value.kOff);
        CANStateR.addObject("Forward", DoubleSolenoid.Value.kForward);
        CANStateR.addObject("Reverse", DoubleSolenoid.Value.kReverse);
        SmartDashboard.putData("Right Solenoid Control", CANStateR);
    }

    public void testPeriodic(){
        intake.leftControl(leftVal);
        intake.rightControl(rightVal);
        intake.SolenoidL((DoubleSolenoid.Value)CANStateL.getSelected());
        intake.SolenoidR((DoubleSolenoid.Value)CANStateR.getSelected());
        // This code is used for testing subsystems independently.
